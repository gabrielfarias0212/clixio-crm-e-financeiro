...
export const parseClient = (data: any): Client => {
  return {
    ...
    preWeddingScheduled: data.pre_wedding_scheduled ?? false,
    preWeddingCompleted: data.pre_wedding_completed ?? false,
    preWeddingDelivered: data.pre_wedding_delivered ?? false,
    contractLink: data.contract_link,
    hasPreWedding: data.has_pre_wedding ?? false,

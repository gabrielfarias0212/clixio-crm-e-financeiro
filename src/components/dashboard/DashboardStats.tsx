  ...
  const monthlyEvents = useMemo(() => {
    ...
    clients.forEach(client => {
      ...
      if (client.weddingDate) {
        ...
        if (weddingDate && isWithinInterval(weddingDate, { start: monthStart, end: monthEnd })) {
          eventsCount++;
        }
      }
      ...
      if (client.preWeddingDate) {
        ...
        if (preWeddingDate && isWithinInterval(preWeddingDate, { start: monthStart, end: monthEnd })) {
          eventsCount++;
        }
      }
    });

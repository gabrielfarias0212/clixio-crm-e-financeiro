  ...
  return (
    <Layout>
      <div className="max-w-screen-xl mx-auto px-4 py-8 animate-fade-in">
        <h1 className="text-2xl font-bold mb-6">Calendário de Casamentos</h1>
                ...
                {selectedDayClients.length > 0 ? (
                  <div>
                    <h2 className="text-lg font-medium mb-4 flex items-center">
                      ...
                      Casamentos em {date && format(date, "dd/MM/yyyy")}
                    </h2>
                  ...
                  <div className="py-12 text-center">
                    <h2 className="text-lg font-medium mb-2">
                      {date ? `Não há casamentos em ${format(date, "dd/MM/yyyy")}` : "Selecione uma data"}
                    </h2>
                    <p className="text-gray-500">
                      Selecione uma data no calendário para ver os casamentos agendados.
                    </p>
                  </div>
                )}
              </CardContent>
              ...
              <CardContent className="pt-6">
                ...
                <div className="mt-4 text-center text-xs text-gray-500">
                  <div className="flex items-center justify-center gap-2">
                    ...
                    <span>Casamentos agendados</span>
                  </div>
                </div>
              </CardContent>
            </Card>

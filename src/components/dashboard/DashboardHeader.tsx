    ...
    <div className="flex flex-col space-y-4">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Gerencie seus projetos e acompanhe o desempenho do seu negócio</p>
        </div>
        <div className="flex flex-col sm:flex-row gap-2 mt-4 md:mt-0">
          <Link to="/clients/add">
            <Button className="text-sm font-bold text-stone-50 bg-lime-900 hover:bg-lime-800 w-full sm:w-auto">
